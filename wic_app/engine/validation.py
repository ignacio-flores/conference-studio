...
def validate_programme_state(
    ...
    validations = {
        ...
        "scheduled_active_papers": len(scheduled_ids),
        "overflow_papers": len(overflow_ids),
        "overflow_active_papers": len(overflow_ids),
        "unassigned_papers": len(unassigned_ids),
        "unassigned_active_papers": len(unassigned_ids),
        "inactive_assigned_papers": len(inactive_scheduled_ids) + len(inactive_overflow_ids),
        "scheduled_in_inactive_sessions": len(inactive_scheduled_ids),
        ...
        "overflow_in_inactive_sessions": len(inactive_overflow_ids),
